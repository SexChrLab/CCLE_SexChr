...
counts <- read.delim('C:/Users/livin/ASU FILES/Reseach Files/Genomic Sex Chromosome/TCGA_RNAseq_counts/TCGA_LIHC_TPM.tsv', row.names = 1) #TCGA_LIHC_TPM.tsv
metadf <- read.delim('C:/Users/livin/ASU FILES/Reseach Files/Genomic Sex Chromosome/TCGA_RNAseq_counts/TCGA_LIHC_META.tsv', row.names = 1) #TCGA_LIHC_META.tsv
